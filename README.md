...
Latitudes with Attitudes (LWA) is web visualization dashboard exercise representing a weather data analysis for 
...
For this project, we'll be creating a visualization dashboard website. Specifically, we'll be plotting weather data.
